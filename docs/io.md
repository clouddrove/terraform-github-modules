...
Every input and output of every module in this repository, with its type and
default. This file is generated from the code with `terraform-docs`; it is the
reference to diff when upgrading between versions.
