...
- Vulnerabilities in the GitHub provider (report to integrations/terraform-provider-github)
...
- Use least-privilege GitHub tokens and app permissions
- Prefer GitHub Actions secrets over Actions variables for anything sensitive
